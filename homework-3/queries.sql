...
INNER JOIN customers ON  customers.customer_id = orders.customer_id AND customers.city=employees.city AND customers.city='London'
...
SELECT products.product_name,units_in_stock,contact_name,suppliers.phone
FROM products
LEFT JOIN suppliers ON products.supplier_id = suppliers.supplier_id
INNER JOIN categories ON categories.category_id = products.category_id AND (category_name = 'Dairy Products' OR category_name = 'Condiments')
